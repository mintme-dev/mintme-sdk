...
function createToken(options) {
  ...
  const uri = options.uri || "https://ipn.mintme.dev/metadata.json";
    ...
    .then((idl) => {
      ...
      return Promise.all([
        ...
        .then((results) => {
          ...
          logger(`🤝 Partner Wallet: ${partnerWallet?.toString() || "Not defined"}`);
          logger(`💸 Partner Amount: ${partnerAmount}`);
          console.log("DIGI_PARTNER_WALLET", partnerWallet);
  ...
  return connection
    ...
    .then((balance) => {
      ...
      return createToken({
        ...
        initialSupply: mergedConfig.initialSupply,
